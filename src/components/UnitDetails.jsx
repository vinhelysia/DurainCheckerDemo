...
export default function UnitDetails({ unitType }) {
  ...
  const unitData = {
    ...
    testing: {
      ...
      status: 'approved',
      telemetry: [
        { label: language === 'vi' ? 'Hàm lượng Cadimi (Cd)' : 'Cadmium (Cd) Level', value: '0.024 ppm', status: 'optimal', limit: '< 0.05 ppm' },
      ...
      blockchainLogs: [
        ...
        { height: '190623', hash: '0xdac4...998f', event: language === 'vi' ? 'Ghi nhận Kết quả Kiểm nghiệm Cd' : 'Cadmium Assay Results Logged', time: '12:45 - 15/06/2026' },
