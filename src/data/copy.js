export const copyData = {
  vi: {
    ...
    hero: {
      eyebrow: 'DurianTrust AI · Demo Ứng dụng Blockchain & AI',
      title: 'Minh bạch chuỗi cung ứng sầu riêng - từ vườn đến cảng xuất khẩu',
      lead: 'Truy xuất nguồn gốc bằng Blockchain và sàng lọc chất lượng bằng AI cho chuỗi xuất khẩu sầu riêng Việt Nam.',
      ctaDemo: 'Xem demo truy xuất lô hàng',
      ctaProblem: 'Tìm hiểu vấn đề',
      batchProof: 'Mã lô hàng',
      ledgerEvents: '4 sự kiện sổ cái / AI đạt / Cd trong ngưỡng demo',
  ...
  en: {
    ...
    hero: {
      eyebrow: 'DurianTrust AI · Blockchain & AI Demo App',
      title: 'Transparent durian supply chain - from farm to export port',
      lead: 'Blockchain traceability and AI quality screening for Vietnam\'s durian export chain.',
      ctaDemo: 'View live demo',
      ctaProblem: 'Learn about the problem',
      batchProof: 'Batch proof',
      ledgerEvents: '4 ledger events / AI pass / Cd within demo threshold',
      verified: 'Verified',
