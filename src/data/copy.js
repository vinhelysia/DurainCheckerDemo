export const copyData = {
  vi: {
    ...
    problem: {
      ...
      photoCaption: 'Sầu riêng là ngành hàng tỷ đô. Chỉ một phát hiện dư lượng hóa chất có thể khiến cả lô hàng bị giữ tại cửa khẩu.',
      figures: [
      ...
      newsTitle: 'Báo chí đã liên tục cảnh báo',
      ...
      bridgeTitle: 'Vấn đề không nằm ở chất lượng trái, mà ở niềm tin vào hồ sơ. Đó là lý do chúng tôi xây DurianTrust.',
      bridgeButton: 'Xem giải pháp',
  ...
  en: {
    ...
    problem: {
      ...
      photoCaption: 'Durian is a multibillion-dollar trade. A single contaminant finding can freeze an entire shipment at the border.',
      figures: [
      ...
      newsTitle: 'The press has been sounding the alarm',
      ...
      bridgeTitle: "The problem is not the fruit's quality, but trust in the paperwork. That is why we built DurianTrust.",
      bridgeButton: 'See the solution',
