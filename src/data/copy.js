...
export const copyData = {
  vi: {
    ...
    landing: {
      ...
      features: [
        {
          kicker: 'AI · Ảnh lá', title: 'Một tấm ảnh, thêm một gợi ý.',
          description: 'Ở cuối trang tra cứu, chọn ảnh lá mẫu hoặc tải ảnh của bạn để mô hình gợi ý nhóm bệnh và hướng chăm sóc tham khảo.',
          steps: ['Chọn ảnh lá', 'Mô hình phân tích', 'Đọc gợi ý'],
          note: 'Gợi ý phục vụ demo, cần xác minh thực tế; ảnh lá không cho biết hàm lượng Cadimi.',
          action: 'Mở tra cứu & AI', href: '#/unit/demo',
          image: 'leaf-ai-illustration.webp', alt: 'Minh họa điện thoại phân tích ảnh lá sầu riêng, bên cạnh lá xanh và lá có đốm nâu',
        },
        {
          kicker: 'Blockchain · Bàn giao', title: 'Bên gửi đề xuất. Bên nhận xác nhận.',
  ...
  en: {
    ...
    landing: {
      ...
      features: [
        {
          kicker: 'AI · Leaf images', title: 'One photo. Another clue.',
          description: 'At the bottom of batch lookup, choose a sample leaf or upload your own image for a suggested disease class and reference care advice.',
          steps: ['Choose a leaf image', 'Run the model', 'Read the suggestion'],
          note: 'Demo suggestions need real-world verification; leaf images cannot measure Cadmium.',
          action: 'Open lookup & AI', href: '#/unit/demo',
          image: 'leaf-ai-illustration.webp', alt: 'Illustration of a phone analyzing a durian leaf beside green and brown-spotted leaves',
        },
        {
          kicker: 'Blockchain · Custody', title: 'The sender proposes. The recipient accepts.',
